...
class TensilePage extends Component {
  ...
  handleStart = event => {
    console.log(this.state.filename, this.state.exposure_time);
  };
  ...
  handleHydrate = event => {
    this.props.Hydrate(this.state.hydrationvol);
  };
    ...
    return (
      <Grid container className={classes.root} spacing={0} direction="column">
        ...
        >
          ...
          <Grid item xs={1}>
            <Button
              onClick={this.handleTensileAcquire}
              className={classNames(classes.button, classes.start)}
            >
              Start
            </Button>
          </Grid>
          ...
          <Grid item xs={1}>
            <Button
              onClick={this.handleHydrate}
              className={classNames(classes.button, classes.hydrate)}
            >
              Hydrate sample
              <ColoriseIcon />
            </Button>
          ...
          >
            <Grid item xs={2}>
              <TextField
                ...
                onKeyPress={this.handleLengthSend}
              />
            </Grid>
            <Grid item xs={2}>
              <TextField
                ...
                onKeyPress={this.handleWidthSend}
              />
            </Grid>
            <Grid item xs={2}>
              <TextField
